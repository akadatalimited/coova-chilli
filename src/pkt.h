...
struct dns_packet_t { /* DNS header from RFC 1035 */
...
/*
 * Helper to obtain a pointer to the variable-length records section that
 * immediately follows a DNS packet header.
 */
#define dns_packet_records(pkt) ((uint8_t *)(((struct dns_packet_t *)(pkt)) + 1))
